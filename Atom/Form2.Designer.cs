namespace Atom
{
	partial class Form2
	{
		...
		private void InitializeComponent()
		{
			...
			this.label1.Text = "Ömer Faruk Taşdemir ";
			// 
			// label2
			// 
			...
			this.label2.Text = "Görsel programlama 2.sınıf";
			// 
			// label3
			// 
			...
			this.label4.Text = "Bilgisayar müh. 1. öğretim ";
			// 
			// button1
			// 
			...
			this.BackgroundImage = global::Atom.Properties.Resources.animal_animal_photography_barbaric_big_561870;
